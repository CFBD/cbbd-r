#' get_game_players
#'
#' @description Returns player box score statistics and metrics on the first 1000 games that match the provided filters, ordered by start date.
#'
...
#' @export
#'
get_game_players <- function(start_date_range = NULL, end_date_range = NULL, team = NULL, conference = NULL, season = NULL, season_type = NULL, tournament = NULL) {
  ...
  # perform api call
  query_cbbd("games/players", list("startDateRange" = start_date_range, "endDateRange" = end_date_range, "team" = team, "conference" = conference, "season" = season, "seasonType" = season_type, "tournament" = tournament))
}
