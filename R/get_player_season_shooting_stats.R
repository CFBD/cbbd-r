...
#' @export
#'
get_player_season_shooting_stats <- function(season, season_type = NULL, team = NULL, conference = NULL, start_date_range = NULL, end_date_range = NULL) {
  ...
  # perform api call
  query_cbbd("stats/player/shooting/season", list("season" = season, "seasonType" = season_type, "team" = team, "conference" = conference, "startDateRange" = start_date_range, "endDateRange" = end_date_range))
}
